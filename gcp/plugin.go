...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"gcp_bigquery_routine":                                    tableGcpBigQueryRoutine(ctx),
			...
			"gcp_cloud_run_domain_mapping":                            tableGcpCloudRunDomainMapping(ctx),
			"gcp_cloud_run_execution":                                 tableGcpCloudRunExecution(ctx),
			"gcp_cloud_run_job":                                       tableGcpCloudRunJob(ctx),
			"gcp_cloud_run_revision":                                  tableGcpCloudRunRevision(ctx),
			"gcp_cloud_run_service":                                   tableGcpCloudRunService(ctx),
			"gcp_cloud_run_worker_pool":                               tableGcpCloudRunWorkerPool(ctx),
			...
			"gcp_compute_network_endpoint_group":                      tableGcpComputeNetworkEndpointGroup(ctx),
			...
			"gcp_firebase_android_app":                                tableGcpFirebaseAndroidApp(ctx),
			"gcp_firebase_app":                                        tableGcpFirebaseApp(ctx),
			"gcp_firebase_ios_app":                                    tableGcpFirebaseIosApp(ctx),
			"gcp_firebase_project":                                    tableGcpFirebaseProject(ctx),
			"gcp_firebase_web_app":                                    tableGcpFirebaseWebApp(ctx),
			...
			"gcp_pam_entitlement":                                     tableGcpPamEntitlement(ctx),
			"gcp_pam_grant":                                           tableGcpPamGrant(ctx),
			...
			"gcp_spanner_backup":                                      tableGcpSpannerBackup(ctx),
			"gcp_spanner_database":                                    tableGcpSpannerDatabase(ctx),
			"gcp_spanner_instance":                                    tableGcpSpannerInstance(ctx),
			"gcp_spanner_instance_config":                             tableGcpSpannerInstanceConfig(ctx),
			"gcp_spanner_instance_partition":                          tableGcpSpannerInstancePartition(ctx),
