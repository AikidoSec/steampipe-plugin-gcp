...
func listDataplexTasks(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (any, error) {
...
func getDataplexTask(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (any, error) {
	var location string
...
func gcpDataplexTaskTurbotData(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (any, error) {
...
func dataplexTaskSelfLink(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (any, error) {
...
func dataplexLakeNameForTask(ctx context.Context, d *transform.TransformData) (any, error) {
